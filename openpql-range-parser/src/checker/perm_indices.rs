use super::{Itertools, LazyLock};

type IdxPermutations = Vec<Vec<u8>>;

pub static PERM11: LazyLock<IdxPermutations> =
    LazyLock::new(|| (0..1).permutations(1).collect_vec());
pub static PERM21: LazyLock<IdxPermutations> =
    LazyLock::new(|| (0..2).permutations(1).collect_vec());
pub static PERM22: LazyLock<IdxPermutations> =
    LazyLock::new(|| (0..2).permutations(2).collect_vec());
pub static PERM31: LazyLock<IdxPermutations> =
    LazyLock::new(|| (0..3).permutations(1).collect_vec());
pub static PERM32: LazyLock<IdxPermutations> =
    LazyLock::new(|| (0..3).permutations(2).collect_vec());
pub static PERM33: LazyLock<IdxPermutations> =
    LazyLock::new(|| (0..3).permutations(3).collect_vec());
pub static PERM41: LazyLock<IdxPermutations> =
    LazyLock::new(|| (0..4).permutations(1).collect_vec());
pub static PERM42: LazyLock<IdxPermutations> =
    LazyLock::new(|| (0..4).permutations(2).collect_vec());
pub static PERM43: LazyLock<IdxPermutations> =
...
pub static PERM_BOARD_5: LazyLock<IdxPermutations> = LazyLock::new(|| {
    vec![
        vec![0, 1, 2, 3, 4],
        vec![0, 2, 1, 3, 4],
        vec![1, 0, 2, 3, 4],
